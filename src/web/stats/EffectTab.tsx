  ...
  return (
    <>
      ...
      <p className={styles.note}>
        Оценка: каждая задача беклога — правка, которая без него попала бы в пулреквест. Размер исправленных — по коммиту исправления, ожидающих — по медиане исправлений.
      </p>
    </>
  );
}
